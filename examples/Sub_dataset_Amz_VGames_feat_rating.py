...
if __name__ == "__main__":
    ...
    # data = pd.read_csv("G:/My Drive/Univ Of Oulu/masters_thesis/preprocess_dataset/datasets/preparation_of_datasets/"
    #                    "Amazon_Video_Games/new_vader/Amazon_Video_Games_Reviews_with_negs.csv",
    #                    sep=",", header=0)

    data = pd.read_csv("G:/My Drive/Univ Of Oulu/masters_thesis/preprocess_dataset/datasets/preparation_of_datasets"
                       "/Amazon_Video_Games/new_vader/Amazon_Video_Games_Reviews_without_negs.csv",
                       sep=",", header=0)
