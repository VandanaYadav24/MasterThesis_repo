...
if __name__ == "__main__":
    ...
    data = pd.read_csv("G:/My Drive/Univ Of Oulu/masters_thesis/preprocess_dataset/"
                       "datasets/preparation_of_datasets/Amazon_Music/new_vader/Amazon_Music_Reviews_with_negs.csv",
                       sep=",", header=0)
    # data = pd.read_csv("G:/My Drive/Univ Of Oulu/masters_thesis/preprocess_dataset/"
    #                    "datasets/preparation_of_datasets/Amazon_Music/new_vader/Amazon_Music_without_negs.csv",
    #                    sep=",", header=0)
    ...
    dense_col = ["review_emb1", "review_emb2", "review_emb3", "review_emb4", "review_emb5",
                 ...
                 "review_emb11", "review_emb12", "review_emb13", "vader_negations"]
