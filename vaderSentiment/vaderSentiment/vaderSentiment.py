...
class SentimentIntensityAnalyzer(object):
    ...
    def polarity_scores(self, text):
        ...
        for i, item in enumerate(words_and_emoticons):
            ...
            sentiments, negation_count = self.sentiment_valence(valence, sentitext, item, i, sentiments, negation_count)

        sentiments = self._but_check(words_and_emoticons, sentiments)

        valence_dict = self.score_valence(sentiments, text, negation_count)

        return valence_dict

    def sentiment_valence(self, valence, sentitext, item, i, sentiments, negation_count):
            ...
            for start_i in range(0, 3):
                ...
                if i > start_i and words_and_emoticons[i - (start_i + 1)].lower() not in self.lexicon:
                    ...
                    if start_i == 2 and s != 0:
                        s = s * 0.9
                    valence = valence + s
                    valence, negation_count = self._negation_check(valence, words_and_emoticons, start_i, i, negation_count)
                    if start_i == 2:
                        valence = self._special_idioms_check(valence, words_and_emoticons, i)

            valence = self._least_check(valence, words_and_emoticons, i)
        sentiments.append(valence)
        return sentiments, negation_count
    ...
    @staticmethod
    def _negation_check(valence, words_and_emoticons, start_i, i, negation_count):
        words_and_emoticons_lower = [str(w).lower() for w in words_and_emoticons]
        if start_i == 0:
    ...
    def score_valence(self, sentiments, text, negation_count):
        if sentiments:
        ...
        sentiment_dict = \
            {"neg": round(neg, 3),
             ...
             "negations_captured": negation_count}
        # "negations_captured": It is not no. of negator words like not, never, etc.
        # but it is no. of impact of negators on lexical words of sentence (negations)
        # Eg: "VADER is not smart, handsome, nor funny." This sentence has 3 negations and 2 negators.
...
#     paragraph = "In my line of work, I use meeting space in hotels often. " \
#                 "In my + years of doing this work, this is the first time I've felt the undeniable pull to go out and " \
#                 "write a hotel review, based solely on my meeting room experience." \
#                 " Though I didn't use a guest room here, my colleagues who did shared that... More"
...
#         negations += vs["negations_captured"]
