...
if __name__ == '__main__':
    df = pd.read_csv("G:/My Drive/Univ Of Oulu/masters_thesis/preprocess_dataset/"
                     "datasets/preparation_of_datasets/Hotel/new_vader/Preprocessed_Hotel_Reviews_dataset.csv")
    ...
    df.to_csv("G:/My Drive/Univ Of Oulu/masters_thesis/preprocess_dataset/"
              "datasets/preparation_of_datasets/Hotel/new_vader/Preprocessed_Hotel_Reviews_dataset.csv", index=False)
